...
Route::middleware('auth')->group(function () {
    ...
    // return (new \App\Ai\Agents\SupportAgent)
        // ->prompt('fitur audits itu untuk apa?');
    // });
    ...
    Route::prefix('/fingerprint')->name('fingerprint.')->group(function () {
        Route::get('/enroll', [FingerprintController::class, 'index'])->name('index');
        Route::post('/save', [FingerprintController::class, 'store'])->name('store');
        Route::get('/data/{user_id}', [FingerprintController::class, 'getFingerprintData']);
        Route::get('/data-all', [FingerprintController::class, 'getAllFingerprintsData']);
    });
